...
$$ H(X) = -2\int_{0}^{\infty} \left(\frac{1}{2}\lambda \mathrm{e}^{-\lambda x}\right) \cdot \left(\log\left(\frac{1}{2}\right) + \log(\lambda) - \lambda x\right) \,dx$$

3. $$f(x) = \frac{1}{\sigma \sqrt{2 \pi}}\mbox{e}^{-(x-\mu)^2/2\sigma^2}, -\infty < x < \infty, \, \sigma >0$$

$$f(x) = \frac{1}{\sigma \sqrt{2 \pi}} \, e^{-(x-\mu)^2 / (2\sigma^2)}$$
$$[H(X) = -\int_{-\infty}^{\infty} f(x) \log f(x) \, dx $$
$$ (H(X)) = -\int_{-\infty}^{\infty} \frac{1}{\sigma \sqrt{2 \pi}} \, e^{-(x-\mu)^2 / (2\sigma^2)} \log \left(\frac{1}{\sigma \sqrt{2 \pi}} \, e^{-(x-\mu)^2 / (2\sigma^2)}\right) \, dx$$
...
$$ H(X) = -\int_{-A}^{A} \frac{1}{A\sqrt{A^2-x^2}} \log_2\left(\frac{1}{A\sqrt{A^2-x^2}}\right) \,dx$$
